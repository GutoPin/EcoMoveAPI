 ...
 */
public record CreateEcoVehicleResource(string Model, int EcoVehicleTypeId, int BatteryLevel, double Latitude, double Longitude, string Status, string ImageUrl, int UserId);